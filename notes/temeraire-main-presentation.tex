  ...
  \begin{column}{0.48\textwidth}
    \begin{block}{\faCogs\quad Pro Run}
      ...
      \begin{itemize}
        ...
        \item Library, Release-Rate und THP werden best\"atigt
      \end{itemize}
    \end{block}
  \end{column}
  \begin{column}{0.48\textwidth}
    \begin{block}{\faClipboardCheck\quad Pro Messpaar}
      \footnotesize
      \begin{itemize}
        \item gleiche Parameter und gleiche Release-Einstellung
        \item Legacy und Temeraire getrennt ausf\"uhren
        \item erst danach das Delta berechnen
      \end{itemize}
    \end{block}
  \end{column}
\end{columns}
