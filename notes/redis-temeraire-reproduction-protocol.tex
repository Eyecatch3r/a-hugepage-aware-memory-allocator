...
approximately \texttt{+0.44\%} and \texttt{+0.48\%} for release-off, and
...
for release-off and \texttt{-2.37\%} for release-on. A fourth balanced rerun
was especially mixed: release-off strongly favored Temeraire at about
\texttt{+3.51\%}, while release-on strongly disfavored Temeraire at about
\texttt{-12.07\%}.
...
\texttt{-12.07\%} release-on result best treated as a transient outlier rather
...
\midrule
THP fixed-order & \texttt{+1.88\%} & \texttt{+0.27\%} & first valid THP run \\
balanced 1 & \texttt{+0.44\%} & \texttt{+0.12\%} & legacy first \\
balanced 2 & \texttt{+0.48\%} & \texttt{+0.38\%} & Temeraire first \\
balanced 3 & \texttt{-0.76\%} & \texttt{-2.37\%} & negative run \\
balanced 4 & \texttt{+3.51\%} & \texttt{-12.07\%} & release-on outlier \\
